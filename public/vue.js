...
(function(global, factory) {
    ...
    function preTransformNode(el, options) {
        if (el.tag === 'input') {
            ...
            if (map['v-model'] && (map['v-bind:type'] || map[':type'])) {
                ...
                branch0.
                if = "(" + typeBinding + ")==='checkbox'" + ifConditionExtra;
    ...
    function genScopedSlot(
        ...
        var fn = "function(" + (String(el.slotScope)) + "){" +
            "return " + (el.tag === 'template' ? el.
                if ?((el.
                    if) + "?" + (genChildren(el, state) || 'undefined') + ":undefined") : genChildren(el, state) || 'undefined': genElement(el, state)) + "}";
